...
syve.courses.create :code => 58060, :name_fi => "Tietokoneverkot", :name_se => "Datornat", :name_en => "Computer Networks",  :credits => 8.0
...
syve.courses.create :code => 58064, :name_fi => "Kayttoliittymat", :name_se => "Anvandargranssnitt", :name_en => "User Interfaces",  :credits => 8.0
syve.courses.create :code => 58081, :name_fi => "Tietamyskannat", :name_se => "Kunskapsbaser", :name_en => "Knowledge Bases",  :credits => 4.0
syve.courses.create :code => 58109, :name_fi => "Tapahtumakasittely", :name_se => "Transaktionsbehandling", :name_en => "Transaction Processing",  :credits => 8.0
syve.courses.create :code => 581550, :name_fi => "Tietamyksen muodostaminen", :name_se => "Kunskapsutvinning", :name_en => "Data Mining",  :credits => 6.0
...
syve.courses.create :code => 581545, :name_fi => "Tietokantojen suorituskyvyn arviointi", :name_se => "Vardering av databaser", :name_en => "Performance Analysis of Databases",  :credits => 4.0
peru.courses.create :code => 58125, :name_fi => "Informaatiojarjestelmat", :name_se => "Informationssystem", :name_en => "Information Systems",  :credits => 8.0
peru.courses.create :code => 58128, :name_fi => "UNIX-perusteet", :name_se => "Grunderna i UNIX", :name_en => "Introduction to UNIX",  :credits => 2.0
syve.courses.create :code => 581255, :name_fi => "Aikalogiikka ja jarjestelmien verifiointi", :name_se => "Temporal logik och verifiering av system", :name_en => "Temporal logic and verification",  :credits => 6.0
...
peru.courses.create :code => 580212, :name_fi => "Tietotekniikan alkeet (paaaineopiskelijoille)", :name_se => "Introduktion till datateknik", :name_en => "Introduction to computing",  :credits => 4.0
...
syve.courses.create :code => 58139, :name_fi => "Tietokoneavusteinen yhteistyo", :name_se => "Datorstott samarbete", :name_en => "Computer-Supported Cooperative Work",  :credits => 6.0
syve.courses.create :code => 581244, :name_fi => "Kompleksiset laskentajarjestelmat", :name_se => "Komplexa berakningsystem", :name_en => "Complex Computation Systems",  :credits => 8.0
syve.courses.create :code => 581245, :name_fi => "Rinnakkaislaskennan algoritmit", :name_se => "Algoritmer for parallellberakning", :name_en => "Algorithms for Parallel Computation",  :credits => 6.0
...
syve.courses.create :code => 58045, :name_fi => "Simulointimenetelmat", :name_se => "Simuleringsmetoder", :name_en => "Simulation",  :credits => 4.0
syve.courses.create :code => 581546, :name_fi => "Ohjelmistojen suorituskyvyn suunnittelu", :name_se => "Prestandaplanering for programvara", :name_en => "Software Performance Engineering",  :credits => 4.0
...
syve.courses.create :code => 58143, :name_fi => "Systeemityon menetelmat", :name_se => "Metoder for systemutveckling", :name_en => "Information Systems Methodologies",  :credits => 8.0
...
syve.courses.create :code => 581243, :name_fi => "Langaton tietoliikenne", :name_se => "Tr?dlos datakommunikation", :name_en => "Wireless Data Communication",  :credits => 6.0
...
syve.courses.create :code => 581254, :name_fi => "Probabilistinen paattely", :name_se => "Probabilistisk sludledning", :name_en => "e",  :credits => 6.0
...
aine.courses.create :code => 581266, :name_fi => "Langattomat tietoliikenneverkot", :name_se => "Tr?dlosa datakommunikationsnat", :name_en => "e",  :credits => 2.0
...
aine.courses.create :code => 581265, :name_fi => "Digitaalinen signaalinkasittely", :name_se => "Digital signalbehandling", :name_en => "Digital Signal Processing",  :credits => 6.0
syve.courses.create :code => 581268, :name_fi => "Ongelmanratkaisu", :name_se => "Problemlosning", :name_en => "e",  :credits => 4.0
syve.courses.create :code => 581269, :name_fi => "Laskennallinen biologia", :name_se => "Berakningsbiologi", :name_en => "Computational Biology",  :credits => 8.0
syve.courses.create :code => 581271, :name_fi => "Kuvankasittelyn sovelluksia", :name_se => "Applikationer for bildhantering", :name_en => "e",  :credits => 4.0
...
syve.courses.create :code => 581288, :name_fi => "Tietoturva", :name_se => "Datasakerhet", :name_en => "Computer Security",  :credits => 4.0
syve.courses.create :code => 581289, :name_fi => "Tietoliikenteen jatkokurssi", :name_se => "Fordjupad kurs i kommunikation", :name_en => "Advanced Topics in Telecommunication Systems",  :credits => 6.0
...
aine.courses.create :code => 581377, :name_fi => "Uusmediasovellusten tekniikat", :name_se => "Tekniker for tillampningar inom nymedia", :name_en => "Techniques for new media applications",  :credits => 6.0
aine.courses.create :code => 581378, :name_fi => "Algoritmisen tietojenkasittelyn perusteet", :name_se => "Principer for algoritmisk databehandling", :name_en => "Principles of algorithmics",  :credits => 4.0
aine.courses.create :code => 581379, :name_fi => "Muuntokoulutuksen peruskurssi (Java)", :name_se => "Grundkurs for examensinriktad fortbildning", :name_en => "Basics for Upgrading Studies",  :credits => 8.0
...
syve.courses.create :code => 581360, :name_fi => "Ohjelmistoprojektien johtaminen ja ryhmadynamiikka", :name_se => "Ledning av programvaruprojekt", :name_en => "Software Project Management and Group Dynamics",  :credits => 5.0
...
aine.courses.create :code => 581389, :name_fi => "Perl-ohjelmointikieli", :name_se => "Programmeringsspr?ket Perl", :name_en => "e",  :credits => 4.0
...
syve.courses.create :code => 58, :name_fi => "Seminaarien ennakkoilmoittautuminen", :name_se => "Forhandsanmalan till seminarierna", :name_en => "Advance registration for seminars",  :credits => 4.0
...
aine.courses.create :code => 581388, :name_fi => "Data-analyysin laskennallisia menetelmia (Fortran)", :name_se => "Dataanalysens berakningsmetoder (Fortran)", :name_en => "e",  :credits => 6.0
...
syve.courses.create :code => 581336, :name_fi => "Laskennan teoria", :name_se => "Berakningsteori", :name_en => "Theory of Computation",  :credits => 6.0
...
syve.courses.create :code => 581356, :name_fi => "Ohjelmistojen tuotteistaminen ja liiketoiminta", :name_se => "Fr?n innovation till programvarumarknad", :name_en => "From Innovation to Software Business",  :credits => 6.0
syve.courses.create :code => 581362, :name_fi => "Ohjelmointikielten periaatteet", :name_se => "Programmeringsspr?kens principer", :name_en => "Principles of Programming Languages",  :credits => 4.0
syve.courses.create :code => 581386, :name_fi => "Rinnakkaisten jarjestelmien ulkoinen kayttaytyminen", :name_se => "Yttre funktioner hos parallella system", :name_en => "Externally observable behaviour of concurrent systems",  :credits => 6.0
syve.courses.create :code => 582401, :name_fi => "Geometriset menetelmat", :name_se => "Geometriska metoder", :name_en => "Geometric Methods",  :credits => 8.0
...
aine.courses.create :code => 581330, :name_fi => "Ohjelmoinnin ja laskennan perusmallit", :name_se => "Modeller for programmering och kalkylering", :name_en => "Models for Programming and Computing",  :credits => 4.0
...
syve.courses.create :code => 582402, :name_fi => "Verkkokaupan tuki Internetissa", :name_se => "Stod for nathandel p? Internet", :name_en => "Electronic Commerce and Internet",  :credits => 6.0
...
syve.courses.create :code => 582406, :name_fi => "Laajakaistaiset IP-verkot", :name_se => "IP-nat p? bredband", :name_en => "Broadband IP Networks",  :credits => 4.0
syve.courses.create :code => 582407, :name_fi => "Software Agent Technology", :name_se => "Agentteknologi for programvaror", :name_en => "Software Agent Technology",  :credits => 4.0
muut.courses.create :code => 582307, :name_fi => "Tietojenkasittely ihmisessa: hidasta ja tehotonta?", :name_se => "Databehandling i manniskan: l?ngsamt och ineffektivt?", :name_en => "Human Data Processing. Slow and inefficient?",  :credits => 2.0
muut.courses.create :code => 582501, :name_fi => "Evaita esiintymisessa onnistumiseen", :name_se => "Vagkost for ett lyckat framtradande", :name_en => "e",  :credits => 2.0
...
peru.courses.create :code => 581241, :name_fi => "Tekoalykielet", :name_se => "Programspr?k for artificiell intelligens", :name_en => "AI Languages",  :credits => 6.0
...
aine.courses.create :code => 58133, :name_fi => "Laskennan teoria", :name_se => "Berakningsteori", :name_en => "Theory of Computation",  :credits => 8.0
aine.courses.create :code => 58069, :name_fi => "Tietoliikenne", :name_se => "Datakommunikation", :name_en => "Data Communications",  :credits => 8.0
aine.courses.create :code => 58129, :name_fi => "UNIX-sovellusalusta", :name_se => "UNIX for tillampningar", :name_en => "UNIX Platform",  :credits => 6.0
...
aine.courses.create :code => 58012, :name_fi => "Yleiskuva atk-alan yhteiskunnallisesta merkityksesta", :name_se => "Oversikt av ADB-branschens sociala betydelse", :name_en => "Social Role of ADP",  :credits => 4.0
...
syve.courses.create :code => 581543, :name_fi => "Neuraaliverkot", :name_se => "Neuralnat", :name_en => "Neural Networks",  :credits => 6.0
syve.courses.create :code => 58093, :name_fi => "Merkkijonomenetelmat", :name_se => "Metoder for behandling av teckenstrangar", :name_en => "String Processing Algorithms",  :credits => 4.0
syve.courses.create :code => 581374, :name_fi => "Kombinatoriset optimointimenetelmat", :name_se => "Kombinatoriska optimeringsmetoder", :name_en => "Methods in combinatorial optimization",  :credits => 4.0
syve.courses.create :code => 58096, :name_fi => "Hajautetut kayttojarjestelmat", :name_se => "Distribuerade operativsystem", :name_en => "Distributed Operating Systems",  :credits => 8.0
syve.courses.create :code => 58108, :name_fi => "Rinnakkaiskasittelyn teoria", :name_se => "Teori for parallell databehandling", :name_en => "Concurrency Theory",  :credits => 8.0
syve.courses.create :code => 58153003, :name_fi => "Ohjelmistojen suorituskyvyn suunnittelu", :name_se => "Prestandaplanering for programvara", :name_en => "Software Performance Engineering",  :credits => 5.0
syve.courses.create :code => 581548, :name_fi => "Tietokoneliikennejarjestelman mallintaminen ja simulointi", :name_se => "Modellering och simulering av datakommunikationssystem", :name_en => "Modelling and Simulation of Data Communication Systems",  :credits => 4.0
syve.courses.create :code => 581549, :name_fi => "LOTOS-spesifiointikieli", :name_se => "LOTOS-specifieringsspr?ket", :name_en => "LOTOS Specification Language",  :credits => 6.0
...
syve.courses.create :code => 58037, :name_fi => "Tietokoneavusteiset oppimisymparistot", :name_se => "Datorstodd undervisning", :name_en => "Computer Uses in Education",  :credits => 8.0
syve.courses.create :code => 582405, :name_fi => "Kayttojarjestelmat II", :name_se => "Operativsystem II", :name_en => "Operating Systems II",  :credits => 4.0
...
syve.courses.create :code => 581257, :name_fi => "Tiedonhakumenetelmat", :name_se => "Metoder for informations?tervinning", :name_en => "Information Retrieval Methods",  :credits => 4.0
syve.courses.create :code => 582448, :name_fi => "Tiedon louhinnan menetelmat", :name_se => "Metoder inom kunskapsutvinning", :name_en => "Data Mining Methods",  :credits => 6.0
syve.courses.create :code => 581381, :name_fi => "Kayttoliittymat II", :name_se => "Anvandargranssnitt II", :name_en => "User Interfaces II",  :credits => 4.0
syve.courses.create :code => 58147, :name_fi => "Koneoppiminen", :name_se => "Maskininlarning", :name_en => "Machine Learning",  :credits => 8.0
syve.courses.create :code => 58144, :name_fi => "Ohjelmointikielten kaantajat", :name_se => "Kompilatorer", :name_en => "Compilers",  :credits => 4.0
syve.courses.create :code => 582410, :name_fi => "Laajojen dokumenttiaineistojen kasittely", :name_se => "Hantering av stora dokumentmaterial", :name_en => "Processing of Large Document Collections",  :credits => 4.0
...
aine.courses.create :code => 582320, :name_fi => "Graafisten kayttoliittymien ohjelmointi", :name_se => "Programming Graphical User Interfaces", :name_en => "Programming Graphical User Interfaces",  :credits => 6.0
aine.courses.create :code => 582322, :name_fi => "Pelit ja virtuaaliymparistot", :name_se => "Pelit ja virtuaaliymparistot", :name_en => "Pelit ja virtuaaliymparistot",  :credits => 6.0
syve.courses.create :code => 582462, :name_fi => "Tietoturvan jatkokurssi", :name_se => "Fortsattningskurs i datasekretess", :name_en => "Advanced Course on Computer Security",  :credits => 4.0
...
aine.courses.create :code => 582321, :name_fi => "Digitaalisen aanenkasittelyn perusteet", :name_se => "r", :name_en => "e",  :credits => 6.0
...
syve.courses.create :code => 582476, :name_fi => "Hajautettu tekoaly", :name_se => "Distribuerad artificiell intelligens", :name_en => "Distributed Artificial Intelligence",  :credits => 4.0
...
syve.courses.create :code => 582479, :name_fi => "Puhekayttoliittymien suunnittelu ja toteutus", :name_se => "r", :name_en => "Design and Development of Speech Interfaces",  :credits => 8.0
syve.courses.create :code => 582481, :name_fi => "Causal Analysis", :name_se => "Kausalitetsanalys", :name_en => "Causal Analysis",  :credits => 4.0
peru.courses.create :code => 582101, :name_fi => "Ohjelmistotekniikan menetelmat", :name_se => "Metoder for programvaruteknik", :name_en => "Methods for Software Engineering",  :credits => 4.0
...
syve.courses.create :code => 581290, :name_fi => "Rakenteisten dokumenttien kasittely", :name_se => "Behandling av strukturerade dokument", :name_en => "Managing Structured Documents",  :credits => 4.0
...
peru.courses.create :code => 582102, :name_fi => "Johdatus tietojenkasittelytieteeseen", :name_se => "Introduktion till datavetenskap", :name_en => "Introduction to Computer Science",  :credits => 4.0
...
syve.courses.create :code => 582411, :name_fi => "Petriverkot", :name_se => "Petrinat", :name_en => "Petri Nets",  :credits => 6.0
syve.courses.create :code => 582413, :name_fi => "Tiedon eristaminen tekstista", :name_se => "Informationsextrahering ur text", :name_en => "Information extraction in text",  :credits => 4.0
...
syve.courses.create :code => 582416, :name_fi => "Ohjelmistoliiketoimintaprojekti", :name_se => "Projekt for programvarubusiness", :name_en => "Software business project",  :credits => 4.0
aine.courses.create :code => 582308, :name_fi => "Johdatus tietotekniikkaoikeuteen", :name_se => "Introduktion till dataratt", :name_en => "e",  :credits => 2.0
syve.courses.create :code => 582417, :name_fi => "Hajautetut jarjestelmat", :name_se => "Distribuerade system", :name_en => "Distributed Systems",  :credits => 4.0
syve.courses.create :code => 581267, :name_fi => "Epataydellisen tiedon kasittelymenetelmat", :name_se => "Hanteringsmetoder for ofullstanding information", :name_en => "Plausible inference with incomplete information",  :credits => 6.0
syve.courses.create :code => 581270, :name_fi => "Kuvankasittelyn perusteet", :name_se => "Grunderna i bildhantering", :name_en => "e",  :credits => 4.0
syve.courses.create :code => 581284, :name_fi => "Tiedon tiivistaminen", :name_se => "Datakomprimering", :name_en => "e",  :credits => 8.0
peru.courses.create :code => 99270, :name_fi => "Englannin tekstinymmartaminen", :name_se => "r", :name_en => "e",  :credits => 4.0
...
syve.courses.create :code => 582419, :name_fi => "Tekoalyn filosofia", :name_se => "Artificiell intelligensens filosofi", :name_en => "Philosophy of Artificial Intelligence",  :credits => 4.0
...
syve.courses.create :code => 582426, :name_fi => "Tiedon louhinnan algoritmiset menetelmat", :name_se => "Algoritmiska metoder i datautvinning", :name_en => "Advanced algorithms in data mining",  :credits => 4.0
...
syve.courses.create :code => 582429, :name_fi => "Laudatur-projektityo", :name_se => "s", :name_en => "Laudatur Project",  :credits => 6.0
...
syve.courses.create :code => 582453, :name_fi => "Sovellusintegraatio verkostotaloudessa ja sahkoisen liiketoiminnan standardit", :name_se => "R", :name_en => "Application integration in a network economy and standards for e-business",  :credits => 8.0
...
syve.courses.create :code => 582460, :name_fi => "Ohjelmistojen vaatimusmaarittely", :name_se => "Kravdefiniering for programvara", :name_en => "Software Requirements Engineering",  :credits => 4.0
...
syve.courses.create :code => 581541, :name_fi => "Tapahtumakasittely", :name_se => "Transaktionsbehandling", :name_en => "Transaction processing",  :credits => 8.0
...
muut.courses.create :code => 581324, :name_fi => "Tietokone tyovalineena", :name_se => "Introduktion till datorn som arbetsredskap", :name_en => "Introduction to the Use of Computers",  :credits => 1.0
...
syve.courses.create :code => 582464, :name_fi => "Autonomisten jarjestelmien yhteistoiminta", :name_se => "r", :name_en => "Collaboration of Autonomous Business Services",  :credits => 4.0
...
muut.courses.create :code => 581256, :name_fi => "Opettajatuutorointi", :name_se => "Lararhandledning", :name_en => "Tutoring",  :credits => 2.0
muut.courses.create :code => 581355, :name_fi => "Tietojenkasittelytieteen esittely", :name_se => "Presentation av datavetenskap", :name_en => "Presenting Computer Science",  :credits => 2.0
muut.courses.create :code => 581390, :name_fi => "Tietokone tyovalineena (sivuaineopiskelijoille)", :name_se => "Introduktion till datorn som arbetsredskap", :name_en => "Introduction to the Use of Computers",  :credits => 4.0
...
aine.courses.create :code => 581331, :name_fi => "Kayttojarjestelmat I", :name_se => "Operativsystem", :name_en => "Operating Systems",  :credits => 4.0
aine.courses.create :code => 581332, :name_fi => "Rinnakkaisohjelmointi", :name_se => "Jamlopande programmering", :name_en => "Concurrent Programming",  :credits => 4.0
...
aine.courses.create :code => 582304, :name_fi => "XML-metakieli", :name_se => "Metaspr?ket XML", :name_en => "The metalanguage XML",  :credits => 4.0
aine.courses.create :code => 582310, :name_fi => "Aineenopettajan tietotekniikka", :name_se => "s", :name_en => "IT for Teachers",  :credits => 4.0
syve.courses.create :code => 58066, :name_fi => "Tekoaly", :name_se => "Artificiell intelligens", :name_en => "Artificial Intelligence",  :credits => 8.0
syve.courses.create :code => 581359, :name_fi => "Ohjelmistoprosessit ja ohjelmistojen laatu", :name_se => "Processer och kvalitet for programvara", :name_en => "Software Processes and Quality",  :credits => 4.0
...
aine.courses.create :code => 581391, :name_fi => "Kayttoliittymat", :name_se => "Anvandargranssnitt", :name_en => "User Interfaces",  :credits => 8.0
...
aine.courses.create :code => 582303, :name_fi => "Verkkosovellusten toteuttaminen", :name_se => "Implementering av natverksapplikationer", :name_en => "Network Programming",  :credits => 7.0
syve.courses.create :code => 582450, :name_fi => "Modelling of Vision", :name_se => "r", :name_en => "Modelling of Vision",  :credits => 5.0
syve.courses.create :code => 581286, :name_fi => "Kolme kasitetta: informaatio", :name_se => "Tre begrepp: information", :name_en => "Three concepts: information",  :credits => 6.0
syve.courses.create :code => 582466, :name_fi => "Puukieliopit", :name_se => "Tradgrammatiker", :name_en => "Tree Grammars",  :credits => 6.0
...
syve.courses.create :code => 581287, :name_fi => "Kolme kasitetta: todennakoisyys", :name_se => "Tre begrepp: sannolikhet", :name_en => "Three concepts: probability",  :credits => 6.0
syve.courses.create :code => 582420, :name_fi => "Valiohjelmistot", :name_se => "Mellanvara", :name_en => "Middleware",  :credits => 4.0
syve.courses.create :code => 582425, :name_fi => "Tosiaikajarjestelmat", :name_se => "Realtidssystem", :name_en => "Real-Time Systems",  :credits => 4.0
syve.courses.create :code => 582439, :name_fi => "Graphical Models", :name_se => "Graphical Models", :name_en => "Graphical Models",  :credits => 6.0
muut.courses.create :code => 582505, :name_fi => "Aidinkielinen viestinta", :name_se => "r", :name_en => "e",  :credits => 3.0
muut.courses.create :code => 582506, :name_fi => "Tutkimustiedonhaku", :name_se => "r", :name_en => "e",  :credits => 1.0
muut.courses.create :code => 582507, :name_fi => "Henkilokohtainen opintosuunnitelma ja osallistuminen opettajatuutorointiin", :name_se => "r", :name_en => "Personal Study Plan and Participating in Teacher Tutoring",  :credits => 2.0
...
syve.courses.create :code => 581339, :name_fi => "Kolme kasitetta: paatoksenteko", :name_se => "Tre begrepp: beslutsfattning", :name_en => "Three concepts: utility",  :credits => 6.0
...
aine.courses.create :code => 582317, :name_fi => "Linux-yllapito", :name_se => "r", :name_en => "Linux System Administration",  :credits => 6.0
...
peru.courses.create :code => 581242, :name_fi => "Tietojenkasittelyn menetelmia", :name_se => "Metoder inom databehandling", :name_en => "Computing Methodologies",  :credits => 6.0
syve.courses.create :code => 58097, :name_fi => "Graafisen tietojenkasittelyn jatkokurssi", :name_se => "Fortsattningskurs i grafisk databehandling", :name_en => "Advanced Computer Graphics",  :credits => 8.0
...
aine.courses.create :code => 582201, :name_fi => "Kayttoliittymat", :name_se => "Anvandargransnitt", :name_en => "User Interfaces",  :credits => 4.0
...
syve.courses.create :code => 582487, :name_fi => "Tiedon tiivistamisen tekniikat", :name_se => "r", :name_en => "Data Compression Techniques",  :credits => 4.0
syve.courses.create :code => 582412, :name_fi => "Kuvankasittely", :name_se => "Bildhantering", :name_en => "Image Processing",  :credits => 6.0
...
aine.courses.create :code => 582323, :name_fi => "Paikkatiedon kasittely", :name_se => "Hantering av geografisk information", :name_en => "Spatial Data Processing",  :credits => 5.0
...
syve.courses.create :code => 582492, :name_fi => "Symbolisesti koodatun musiikin hakumenetelmat", :name_se => "r", :name_en => "e",  :credits => 4.0
...
syve.courses.create :code => 582614, :name_fi => "Tekoaly tietokonepeleissa", :name_se => "Artificiell intelligens for spel", :name_en => "Artificial Intelligence for Games",  :credits => 4.0
...
syve.courses.create :code => 581274, :name_fi => "Paikkatietojarjestelmat", :name_se => "Geografiska informationssystem", :name_en => "Spatial Information Systems",  :credits => 4.0
...
aine.courses.create :code => 582206, :name_fi => "Laskennan mallit", :name_se => "Berakningsmodeller", :name_en => "Models of Computation",  :credits => 6.0
syve.courses.create :code => 582601, :name_fi => "XML-tietokannat", :name_se => "XML-databaser", :name_en => "XML Databases",  :credits => 4.0
syve.courses.create :code => 582602, :name_fi => "Natural Language Processing", :name_se => "Hantering av naturligt spr?k", :name_en => "Natural Language Processing",  :credits => 8.0
aine.courses.create :code => 582324, :name_fi => "Kyselykielet", :name_se => "Fr?gespr?k", :name_en => "Query Languages",  :credits => 4.0
...
syve.courses.create :code => 582497, :name_fi => "Kayttojarjestelmat", :name_se => "r", :name_en => "Operating Systems",  :credits => 8.0
...
syve.courses.create :code => 582661, :name_fi => "Deterministisia hajautettuja algoritmeja", :name_se => "r", :name_en => "Deterministic Distributed Algorithms",  :credits => 3.0
aine.courses.create :code => 582337, :name_fi => "AI for Games II", :name_se => "AI for Games II", :name_en => "AI for Games II",  :credits => 3.0
syve.courses.create :code => 582663, :name_fi => "Ohjelmistoarkkitehtuurien harjoitustyo", :name_se => "r", :name_en => "Software Architecture Project",  :credits => 3.0
...
syve.courses.create :code => 582631, :name_fi => "Johdatus koneoppimiseen", :name_se => "Introduktion till maskininlarning", :name_en => "Introduction to Machine Learning",  :credits => 4.0
syve.courses.create :code => 582634, :name_fi => "Tiedon louhinta", :name_se => "Datautvinning", :name_en => "Data Mining",  :credits => 4.0
syve.courses.create :code => 582636, :name_fi => "Todennakoisyysmallit", :name_se => "Sannolikhetsmodeller", :name_en => "Probabilistic Models",  :credits => 4.0
...
aine.courses.create :code => 582640, :name_fi => "Kayttojarjestelmat", :name_se => "r", :name_en => "Operating Systems",  :credits => 4.0
...
muut.courses.create :code => 584402, :name_fi => "Harjoittelu tai tyoelamaan orientoituminen", :name_se => "Harjoittelu tai tyoelamaan orientoituminen", :name_en => "Harjoittelu tai tyoelamaan orientoituminen",  :credits => 1.0
...
syve.courses.create :code => 582660, :name_fi => "Kaytettavyyden arviointi", :name_se => "r", :name_en => "Usability Evaluation",  :credits => 4.0
...
syve.courses.create :code => 582668, :name_fi => "Merkkijonomenetelmien harjoitustyo", :name_se => "r", :name_en => "Project in String Processing Algorithms",  :credits => 2.0
...
syve.courses.create :code => 582651, :name_fi => "Informaatioteoreettisen mallintamisen harjoitustyo", :name_se => "Projekt i informationssteoretisk modellering", :name_en => "Project in Information-Theoretic Modeling",  :credits => 2.0
aine.courses.create :code => 582331, :name_fi => "Kettera web-kehitys ja Ruby on Rails", :name_se => "r", :name_en => "Agile Web Development and Ruby on Rails",  :credits => 4.0
...
aine.courses.create :code => 582332, :name_fi => "Ohjelmointi Python-kielella", :name_se => "r", :name_en => "Programming in Python",  :credits => 4.0
aine.courses.create :code => 582334, :name_fi => "TDD-ohjelmointimenetelma ja koodin suunnittelu", :name_se => "r", :name_en => "TDD Programming Technique and Designing Code",  :credits => 5.0
...
syve.courses.create :code => 582656, :name_fi => "Kaytettavyyssuunnittelu", :name_se => "Anvandbarhetsdesign", :name_en => "Usability Engineering",  :credits => 4.0
...
syve.courses.create :code => 582641, :name_fi => "Autonomisten jarjestelmien yhteistoiminta", :name_se => "Autonomisten jarjestelmien yhteistoiminta", :name_en => "Collaboration of Autonomous Business Services",  :credits => 4.0
...
muut.courses.create :code => 582510, :name_fi => "Henkilokohtainen opintosuunnitelma (FM-HOPS)", :name_se => "Henkilokohtainen opintosuunnitelma (FM-HOPS)", :name_en => "Henkilokohtainen opintosuunnitelma (FM-HOPS)",  :credits => 1.0
...
aine.courses.create :code => 582339, :name_fi => "Internet ilmiona", :name_se => "r", :name_en => "Internet as a Phenomenon",  :credits => 2.0
...
aine.courses.create :code => 582216, :name_fi => "Johdatus tekoalyyn", :name_se => "r", :name_en => "Introduction to Artificial Intelligence",  :credits => 4.0
...
syve.courses.create :code => 582633, :name_fi => "Diskreetin optimoinnin harjoitustyo", :name_se => "Ovningsarbete i diskret optimering", :name_en => "Discrete Optimization Project",  :credits => 2.0
syve.courses.create :code => 582635, :name_fi => "Tiedon louhinnan harjoitustyo", :name_se => "Ovningsarbete i datautvinning", :name_en => "Data Mining Project",  :credits => 2.0
syve.courses.create :code => 582637, :name_fi => "Todennakoisyysmallien harjoitustyo", :name_se => "Ovningsarbete i sannolikhetsmodeller", :name_en => "Project in Probabilistic Models",  :credits => 2.0
...
syve.courses.create :code => 582648, :name_fi => "Ohjelmointikielten kaantajien harjoitustyo", :name_se => "r", :name_en => "Compilers Project",  :credits => 4.0
...
muut.courses.create :code => 584403, :name_fi => "Syventava harjoittelu tai tyoelamaan orientoivat opinnot", :name_se => "Syventava harjoittelu tai tyoelamaan orientoivat opinnot", :name_en => "Syventava harjoittelu tai tyoelamaan orientoivat opinnot",  :credits => 2.0
