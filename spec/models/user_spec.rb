...
describe User do
     ...
     describe "authetication" do
          it "should receive valid arguments" do
               LDAP.should_receive(:autheticate).with("petri", "karjalainen").and_return(true)
               User.authetication("petri", "karjalainen").username.should == "petri"
          end
          ...
          it "should fail when it receives invalid arguments" do
               LDAP.should_receive(:autheticate).with("petri", "karjalainen").and_return(false)
               User.authetication("petri", "karjalainen").should == nil
          end
     end
end
